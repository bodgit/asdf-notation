...
# NOTE: You might want to remove this if notation is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if notation has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert notation executable exists.
		local tool_cmd
